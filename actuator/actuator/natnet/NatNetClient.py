...
# Unpack Mocap Data Functions
    ...
    def send_request(self, in_socket, command, command_str, address):
        ...
        if command == self.NAT_REQUEST_MODELDEF or command == self.NAT_REQUEST_FRAMEOFDATA: #type: ignore  # noqa E501
            ...
            #     tmp_version[0], tmp_version[1], tmp_version[2], tmp_version[3]))
    ...
    def shutdown(self):
        ...
        # shutdown(SHUT_RDWR) immediately interrupts any blocking recvfrom in
        # another thread; close() alone is not reliable for that on Linux.
